...
enum
{
  ...
  PAD_ERR_STATUS = 0x0011,
};

enum N64PadButton
{
  PAD_BUTTON_LEFT = 0x0200,
  PAD_BUTTON_RIGHT = 0x0100,
  PAD_BUTTON_DOWN = 0x0400,
  PAD_BUTTON_UP = 0x0800,
  PAD_TRIGGER_Z = 0x2000,
  PAD_TRIGGER_R = 0x0010,
  PAD_TRIGGER_L = 0x0020,
  PAD_BUTTON_A = 0x8000,
  PAD_BUTTON_B = 0x4000,
  PAD_BUTTON_START = 0x1000,
  PAD_BUTTON_C_UP = 0x0008,
  PAD_BUTTON_C_DOWN = 0x0004,
  PAD_BUTTON_C_LEFT = 0x0002,
  PAD_BUTTON_C_RIGHT = 0x0001,
};
